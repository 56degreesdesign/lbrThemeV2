...
?>
<div class="absolute bottom-3 left-0 w-full z-10 px-3.5 text-beige-light flex justify-between <?php echo ($desktop_absolute) ? 'lg:px-3.5 lg:bottom-3.5 xl:px-6 xl:bottom-5' : 'lg:text-black lg:mt-2.5 lg:static lg:px-0 2xl:mt-6'; ?>">
