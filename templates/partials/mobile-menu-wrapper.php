...
?>
<div class="mobile-menu__wrapper -translate-y-full duration-300 transition-transform fixed w-full h-screen top-0 left-0 overflow-auto z-[25] overflow-x-clip">
    <div class="container flex flex-col h-full justify-between overflow-x-clip">
        <div class="mobile-menu__wrapper__submenu absolute top-0 left-0 w-full z-10">
            <button class="mobile-menu__btn-back sticky top-0 w-full font-bold text-12 text-center mb-16 pt-28" aria-label="Back to menu">BACK</button>
            <div class="mobile-menu__wrapper__submenu__wrapper mobile-menu__menu !pt-0">
                
            </div>
        </div>
        <div class="mobile-menu__wrapper__menu duration-500 -mx-[25px]">
            <?php
                wp_nav_menu(array(
            ...
            <div class="mobile-menu__wrapper__text flex justify-center mb-12 gap-x-1">
            ...
            <div class="mobile-menu__wrapper__text text-13 text-center mb-7">
                <?= $footer['copy_mobile']; ?>
            </div>
