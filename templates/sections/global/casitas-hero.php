...
<section class="bg-beige-light pt-14 pb-10 md:pb-14 lg:pb-20">
    <div class="container grid-layout">
        ...
        <div class="col-span-full flex flex-col justify-center items-center lg:col-start-4 lg:col-span-6">
            ...
            <a class="bg-orange uppercase px-12 text-center pt-2.5 pb-2 text-15 w-fit text-white font-bold rounded-full hover:opacity-70 duration-300 " href="#">
...
<section class="">
    <div class="relative">
        ...
        <div class="grid grid-cols-2 lg:h-full max-w-[1920px] mx-auto z-10">
            <div class="col-span-full bg-beige px-[25px] md:px-10 lg:pr-0 lg:pl-[3.563rem] pt-14 pb-20 lg:col-span-1">
            ...
            <div class="col-span-full bg-beige-light lg:col-span-1">
                <div class="grid grid-cols-2">
                    <div class="col-span-1">
                        <div class="border border-orange py-4 text-orange txt-h5 text-center | lg:py-8">ONE STORY CASITA</div>
                    </div>
                    <div class="col-span-1">
                        <div class="bg-orange py-4 text-white txt-h5 text-center h-full | lg:py-8">TWO STORY CASITA</div>
                    </div>
             </div>
                <div class="flex flex-col justify-center items-center px-[25px] md:px-10 lg:px-0 lg:h-full py-12 md:py-16 lg:py-0">
                    <h3 class="txt-h2 mb-5 md:mb-8 lg:mb-12">STRATA<br>
                        ONE STORY CASITA<br>
                        2 BED / 2.5 BATH<br>
                        Single GARAGE
                    </h3>
                    <p class="txt-h5 text-center mb-7 md:mb-10 lg:mb-14">LOCATED ON LOTS<br>
                        18 – 21</p>
