<section class="">
    <div class="relative">
        ...
        <div class="grid grid-cols-2 max-w-[1920px] mx-auto z-10 lg:h-full">
            ...
            <div class="col-span-full bg-beige pt-7 pb-10 md:pt-14 md:pb-12 lg:pb-10 lg:col-span-1 lg:pr-0 xl:pt-28 xl:pb-14">
                <div class="flex justify-center lg:px-[10%] xl:px-[15%] 2xl:px-[21.67%] lg:mb-10 xl:mb-14">
