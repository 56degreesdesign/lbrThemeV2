...
<div id="<?php echo $anchor ?>" class="relative lg:overflow-hidden">
    ...
    <div class="cards-animate w-screen">
        ...
        <section data-index="<?= $key; ?>" class="bg-beige-light card-animate__item z-10 lg:overflow-hidden lg:shadow-2xl lg:h-screen <?= $key == 0 ? 'relative' : 'relative lg:absolute w-full top-0 left-0' ?>">
                <div class="container grid-layout pb-20 lg:h-screen lg:py-28">
                    ...
                    <div class="col-span-full relative mb-11 -mx-[25px] md:-mx-10 lg:mx-0 lg:mb-0 lg:col-span-6 flex items-center xl:col-span-5">
                    ...
                    <div class="col-span-full lg:row-start-auto lg:col-start-8 lg:col-span-5 xl:col-start-8 xl:col-span-4 wysiwyg flex flex-col items-center justify-center">
