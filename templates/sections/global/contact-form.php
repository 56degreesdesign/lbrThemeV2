...
<section class="bg-beige pt-40 pb-32">
    <div class="container grid-layout">
        <h4 class="col-start-1 col-span-2 txt-h4"><?php echo $label ?></h4>
        <div class="col-start-3 col-span-4 mb-20">
            <h4 class="txt-h4 mb-5"><?php echo $heading ?></h4>
            <p class="txt-1"><?php echo $content ?></p>
        </div>
        <div class="col-span-full">
<!--            --><?php //echo do_shortcode($form); ?>
            <div class="contact-forms-wrapper min-h-[648px] md:min-h-[681px] relative">
