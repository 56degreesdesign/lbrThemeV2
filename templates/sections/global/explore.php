...
<section class="bg-beige-light pt-12 pb-20 md:pt-16 md:pb-28 lg:pt-20 lg:pb-24 2lg:pb-32 2xl:pb-36">
    <div class="container grid grid-cols-2">
        <?php if($heading) :?>
            <h4 class="col-span-full text-center mb-10 md:mb-14 lg:mb-20 txt-5 hidden lg:block"><?php echo $heading ?> </h4>
        <?php endif ;?>
        ...
        <div class="col-span-full -mr-[25px] lg:hidden">
            <div class="text-center mb-10 md:mb-14 lg:mb-20 txt-5 mr-[25px] relative">
