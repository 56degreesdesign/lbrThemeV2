...
if($section) :
?>
    <section class="bg-beige-light pt-11 md:pt-12 lg:pt-40 lg:pb-14 xl:pt-52 xl:pb-80 relative">
        <div class="container grid-layout">
            ...
            <?php endif ;?>
            <?php if($description) :?>
                <div class="col-span-full text-center leading-1.38 text-20 mb-11 lg:text-left lg:col-start-7 lg:col-span-6 xl:text-26 lg:mb-32 xl:mb-36"><?php echo $description ?></div>
            <?php endif ;?>
            <?php if($list) :?>
            ...
            <div class="col-span-full lg:col-start-7 pb-12 lg:pb-0 lg:col-span-6 lg:grid lg:grid-cols-2 gap-x-[30px]">
                <?php foreach ($images as $image) : ?>
                    <div class="mb-7 md:mb-8 lg:mb-14 <?php echo ($image['size']) ? 'lg:col-span-2' : 'lg:col-span-1'; ?>">
