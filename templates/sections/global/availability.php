...
<?php if($section && $interactive) : ?>
    <section id="vue-space" class="resort">
        <div class="bg-beige min-[650px]:py-10 md:pt-20 lg:pb-10 lg:pt-24 xl:pt-28">
...
<section id="<?php echo $anchor ?>" class="bg-beige pt-20 pb-72 lg:pt-28 lg:pb-16 min-[650px]:h-auto min-[650px]:py-14">
    <div class="container grid-layout">
        ...
        <div class="col-span-full lg:col-start-1 lg:col-span-2 hidden min-[650px]:block">
        ...
        <div class="col-span-1 md:col-span-3 flex items-end lg:hidden">
            <img class="max-w-[150px] hidden min-[650px]:block" src="<?php echo $section['legend']['url']?>" alt="">
        </div>
        <div class="col-span-3 pl-5 md:pl-0 md:col-start-4 md:col-span-9 2xl:row-start-1 2xl:row-span-2 hidden min-[650px]:block">
