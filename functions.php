...
require get_stylesheet_directory() . '/includes/utils/featured-image.php';
require get_stylesheet_directory() . '/includes/utils/social-sharing.php';
...
require get_stylesheet_directory() . '/includes/cpt/blog.php';
